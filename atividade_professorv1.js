...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadActivities() {
        const storedActivities = JSON.parse(localStorage.getItem("activities_v1")) || [];
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function saveTodoList() {
        ...
        localStorage.setItem("todoList_v1", JSON.stringify(todos));
    }

    // Carregar a lista do LocalStorage
    function loadTodoList() {
        const savedTodos = JSON.parse(localStorage.getItem("todoList_v1")) || [];
